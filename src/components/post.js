...
const Post = ({ post }) => {
  ...
  return (
    ...
    }}><div className="div1" ><h1 className=""></h1></div>
       <div className="div5"><h2 style={{ paddingTop: `10px`, paddingLeft:`10px`,  fontWeight: `bold`,    textShadow: `.5px .5px .5px rgba(255,255,255, .5)`,
